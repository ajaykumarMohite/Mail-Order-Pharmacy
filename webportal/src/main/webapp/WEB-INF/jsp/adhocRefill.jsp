...
body{
  /* background-image:  radial-gradient(circle, rgba(238,174,202,1) 0%, rgba(148,233,229,1) 100%); */
...
<body>
    ...
    <nav class="navbar navbar-inverse ">
        ...
        <a href="/webportal/home">Back To Home</a>
    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="/webportal/postAdhocRefill">
            ...
            <div class="row">
                ...
                <div class="col d-flex justify-content-left">
                    <input type="text" id="location" name="location" value="<%=session.getAttribute("location")%>" class="w-50" readonly="readonly"><br>
                </div>
            </div>
