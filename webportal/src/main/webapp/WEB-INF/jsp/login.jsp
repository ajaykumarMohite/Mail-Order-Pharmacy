...
<%-- 	<div id="loginModal" class="modal">
		...
		<form class="modal-content animate" name="loginform" model="UserData"
			...
			<h1 class="center"><img width="60px" height="60px"src="images/logo1.png">Login</h1>
			<span
...
<div align="center"  id="heading">
	<h1 class="center"><b>OPTIMUS PHARMA - MAIL ORDER PHARMACY </b>	</h1>
	<h3>"We think about your <b>HAPPINESS</b> "</h3>
	</div>
