...
class MemberSubscriptionTest {
	...
	MemberSubscription member = new MemberSubscription(1, 1, "pranav", LocalDate.now(), 20, "Paracetamol", 3, "Chennai",
			"true");
	...
	public void testMemberId() {
		...
		assertEquals("pranav", member.getMemberId());

	}
	@Test
	public void testMemberId1() {
		member2.setMemberId("shailesh");
		assertEquals("shailesh", member2.getMemberId());
