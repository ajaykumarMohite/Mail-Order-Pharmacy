...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> subscriptionListEmptyException(
			SubscriptionListEmptyException subscriptionListEmptyException) {
		return new ResponseEntity<>(new ExceptionResponse(subscriptionListEmptyException.getMessage(),
	...
	public ResponseEntity<ExceptionResponse> subscriptionNotFoundException(
			SubscriptionNotFoundException subscriptionNotFoundException) {
		return new ResponseEntity<>(new ExceptionResponse(subscriptionNotFoundException.getMessage(),
				LocalDateTime.now(), HttpStatus.NOT_FOUND), HttpStatus.NOT_FOUND);
	}
